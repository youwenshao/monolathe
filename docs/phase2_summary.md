...
sudo cp deployments/studio/mlx_server.service \
     /etc/systemd/system/monolathe-mlx.service

# Enable and start
sudo systemctl daemon-reload
sudo systemctl enable monolathe-mlx
sudo systemctl start monolathe-mlx

# Monitor
sudo systemctl status monolathe-mlx
journalctl -u monolathe-mlx -f
```
