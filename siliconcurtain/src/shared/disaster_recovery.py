...
class BackupManager:
    ...
    async def create_backup(self, backup_type: str = "full") -> dict[str, Any]:
        ...
        backup_name = f"siliconcurtain_{backup_type}_{timestamp}"
    ...
    async def _cleanup_old_backups(self) -> int:
        ...
        for backup_file in self.backup_dir.glob("siliconcurtain_*.tar.gz"):
    ...
    async def list_backups(self) -> list[dict[str, Any]]:
        ...
        for metadata_file in self.backup_dir.glob("siliconcurtain_*.json"):
            try:
